...
public class TelnetCodec extends TransportCodec {
    ...
    /**
     * if channel has charset attribute,return;
     * else if url has charset parameter,return;
     * if both not have, return gbk;
     * if gbk throws exception, return defaultCharset.
     * @param channel
     * @return
     */
